...
window.onload = ()=>{
	(document.getElementById("form_intensities") as HTMLFormElement).onchange=Calculate_Thymus;
...
function Calculate_Thymus() {   
  	let thymus_in = parseFloat((document.getElementById("thymus_in") as HTMLFormElement).value);
    let thymus_out = parseFloat((document.getElementById("thymus_out") as HTMLFormElement).value);
	let muscle_in = parseFloat((document.getElementById("muscle_in") as HTMLFormElement).value);
	let muscle_out = parseFloat((document.getElementById("muscle_out") as HTMLFormElement).value);
