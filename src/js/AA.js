...
function CalculateAD()
{
    ...
    text = text + " an ascending aortic diameter of <b><font color=\"#42f4eb\">" + ADiam.toFixed(2) + "</font></b> cm<sup>2</sup>:<br>";
    text = text + " would be less than the 95<sup>th</sup> percentile if the patient's BSA is greater than <b><font color=\"#edca4e\">" + guesses.last.BSA.toFixed(2) + "</font></b> m<sup>2</sup>:<br>";
